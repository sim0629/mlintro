...
\ref{sec:quadrant_pooling}절에서 사분면에 대한 sum pooling에 대해 설명하였다.
...
Training 할 때와 testing 할 때 같은 pooling 방식을 사용한다.
...
\subsubsection{Stochastic pooling}

\subsubsection{Stochastic max pooling}
